...
const starts = async (dogexeon = new WAConnection()) => {
	...
	console.log(color('\n> YT CHANNEL: Dyno Edits ','silver'))
console.log(color('> GITHUB: Dyno4bxyz ','silver'))
console.log(color('> WA NUMBER: +918421167416 ','silver'))
console.log(color('  ~Dyno Bot Inc. 2021','mediumseagreen'))
	dogexeon.browserDescription = [ 'Subscribe Dyno Edits', 'ubuntu', '3.0' ]
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "918421167416@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["918421167416@s.whatsapp.net","918421167416@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "918421167416@s.whatsapp.net"
