//-----(Doge Bot by ~Dyno Bot Inc.)-----\\
//-----(Youtube Channel: Dyno Edits)-----\\
//-----(Whatsapp number: +918421167416)-----\\
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Doge Bot`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/918421167416`}}})
		}
		const simir = (teks) => {
...
if(isButton == 'igm'){
reply('https://github.com/Dyno4bxyz')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel/UCtWedsM6qnxD7WUMWuDZZeg')
}
...
──────────────────
*👇SCRIPT GITHUB LINK👇*
https://github.com/Dyno4bxyz/DogeBot2
_BASE : ~Dyno Bot Inc._
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/Dyno4bxyz/DogeBot2"
        },
        "index": 0
      }
    ]
